...
<html>
	...
	<body>
		<div style="width: 95%; margin: auto; margin-top: 25px;">
			<h1>学院信息编辑</h1>
			<form class="ui form" action="<%=path %>/xuyuanEdit.action" name="form1" method="post">
				<div class="field">
					<label>学院编号：</label>
					<input name="xuyuanBianhao" type="text" value="<s:property value="#request.xuyuan.xuyuanBianhao"/>"/>
				</div>
				<div class="field">
					<label>学院名称：</label>
					<input type="text" name="xuyuanName" value="<s:property value="#request.xuyuan.xuyuanName"/>"/>
				</div>
				<div class="field">
					<label>学院简介：</label>
